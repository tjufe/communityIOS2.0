...
//添加新评论
+(void)statusToolAddNewEstimateWithShop_id:(NSString *)shop_id Content:(NSString *)content Score:(NSString *)score User_id:(NSString *)user_id  Success:(StatusSuccess)success failurs:(StatusFailurs)failure{
    NSMutableDictionary *firstDic = [[NSMutableDictionary alloc]init];
    ...
    NSMutableDictionary *thirdDic = [[NSMutableDictionary  alloc] init];
    [thirdDic setValue:secondDic forKey:@"param"];
    [thirdDic setValue:@"AddNewEstimate" forKey:@"method"];
...
+(void)statusToolEnsureOrderWithOrder_id:(NSString *)order_id  Success:(StatusSuccess)success failurs:(StatusFailurs)failure{
    ...
    NSMutableDictionary *thirdDic = [[NSMutableDictionary  alloc] init];
    [thirdDic setValue:secondDic forKey:@"param"];
    [thirdDic setValue:@"EnsureOrder" forKey:@"method"];
...
+(void)statusToolAddNewOrderInfoWithShopID:(NSMutableArray *)shop_id CustID:(NSString *)cust_id CustName:(NSString *)cust_name CustPhone:(NSString *)cust_phone OrderMoney:(NSMutableArray *)order_money OrderSendfee:(NSMutableArray *)order_sendfee OrderState:(NSString *)order_state OrderAddress:(NSString *)order_address PayType:(NSString *)pay_type CommID:(NSMutableArray *)comm_id CommUnit:(NSMutableArray *)comm_unit CommPrice:(NSMutableArray *)comm_price CommName:(NSMutableArray *)comm_name BuyAmount:(NSMutableArray *)buy_amount CommType:(NSMutableArray *)comm_count OrderID:(NSString *)order_id Success:(StatusSuccess)success failurs:(StatusFailurs)failure{
    ...
    [firstDic setValue:cust_name forKey:@"cust_name"];
    [firstDic setValue:cust_phone forKey:@"cust_phone"];
    [firstDic setValue:order_money forKey:@"order_money_array"];
    [firstDic setValue:order_sendfee forKey:@"order_sendfee_array"];
    [firstDic setValue:order_state forKey:@"order_state"];
    [firstDic setValue:order_address forKey:@"order_address"];
    [firstDic setValue:pay_type forKey:@"pay_type"];
    [firstDic setValue:comm_id forKey:@"comm_id_array"];
    [firstDic setValue:comm_unit forKey:@"comm_unit_array"];
    [firstDic setValue:comm_price forKey:@"comm_price_array"];
...
+(void)statusToolChangeMessageStateWithMessage_id:(NSString *)message_id  Success:(StatusSuccess)success failurs:(StatusFailurs)failure{
    ...
    NSMutableDictionary *firstDic = [[NSMutableDictionary alloc]init];
    [firstDic setValue:message_id forKey:@"message_id"];
    
    NSMutableDictionary *secondDic = [[NSMutableDictionary  alloc] init];
    [secondDic  setValue:firstDic forKey:@"Data"];
    NSMutableDictionary *thirdDic = [[NSMutableDictionary  alloc] init];
    [thirdDic setValue:secondDic forKey:@"param"];
    [thirdDic setValue:@"ChangeMessageState" forKey:@"method"];
